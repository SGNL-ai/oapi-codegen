...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:bAxg2vxgnHHHoeefVdmGbR+oxtJlcv5HsJJa3qmAHuo=",
        version = "v0.94.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:N6Qsn6TUsDzz+qgS/1xcfBtkQfnbwW01fLFJpuYgKsg=",
        version = "v1.2.24",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nF9mHSvoKBLkQNQhJZNsc66z2UzAMUbLGjC95CF3pU0=",
        version = "v0.0.0-20220513224357-95641704303c",
    )

...
//go:generate go run github.com/sgnl-ai/oapi-codegen/cmd/oapi-codegen --old-config-style --package=petstore --generate types,client -o ../petstore-client.gen.go ../petstore-expanded.yaml

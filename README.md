...
directory does a lot of that for you. You would run it like so:
    ...
    go get github.com/sgnl-ai//oapi-codegen/cmd/oapi-codegen
...
import (
	...
	"github.com/sgnl-ai//oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/sgnl-ai//oapi-codegen/pkg/gin-middleware"
)
...
```go
    import (
        "github.com/sgnl-ai//oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/sgnl-ai//oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  - skip-prune
import-mapping:
  ./packageA/spec.yaml: github.com/sgnl-ai//oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/sgnl-ai//oapi-codegen/internal/test/externalref/packageB
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/sgnl-ai//oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48)
...
let's call it `github.com/sgnl-ai//some-package`. You need to tell `oapi-codegen` that
`some_spec.yaml` corresponds to this package, and you would do it by specifying
this command line argument:

    -import-mapping=./some_spec.yaml:github.com/sgnl-ai//some-package

This tells us that in order to resolve references generated from `some_spec.yaml` we
need to import `github.com/sgnl-ai//some-package`. You may specify multiple mappings
